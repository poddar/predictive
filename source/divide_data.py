# -*- coding: utf-8 -*-
"""
Created on Mon Oct 21 17:46:07 2013
...
def run(whole_file,analysis_folder,factors_arr,train_per,test_per,folds,factors_str,clean_start,granularity):
    #---WHOLE FILE
    #y_all=pd.read_csv('../data/shuffled_september_site_ad',sep='|')
    ...
    ##=----Only Change Here---=##
    ###========================###
    select='sequential' #selecting how to divide data sequential, random_day, random_all
    k=folds
